...
<dl>
	...
	<dd>
		...
		<dl>
			...
			<dd>
				<ul>
					<li class="evolution_majeure" title="Evolution majeure">Gestion des utilisateurs désactivés dans les différentes ihms.</li>
					...
					<li class="evolution_mineure" title="Evolution mineure">Amélioration de la charte graphique</li>
			...
			<dd>
				<ul>
					...
					<li class="evolution_majeure" title="Evolution majeure">Ajout de l'ihm d'impression synthèse annuel d'une compétence pour une classe.</li>
