...
<h1>Edition de l'&eacute;valuation collective</h1>
...
<form method="post" action="?page=evaluations_collectives&amp;mode=edit_do">
	<table class="formulaire">
		...
		<tr>
			<td>Date</td>
			<td><input type="text" name="EVAL_COL_DATE" size="<?php echo(EVAL_COL_DATE); ?>" maxlength="<?php echo(EVAL_COL_DATE); ?>" value="<?php echo($aEvalCol['EVAL_COL_DATE']); ?>" /></td>
		</tr>
		<tr>
			<td>
