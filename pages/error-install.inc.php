...
<!-- ================================================== -->
<body>
	<h1>Désolé, mais une erreur trop importante a eu lieu.</h1>
	<p>Il semblerait que l'installation de ProjectSion n'ait pas été effectuée.<br />
	Afin de pouvoir utiliser cette application, veuillez suivre les indications de l'installeur.</p>
	<p><a href="install/">Installation de ProjectSion</a></p>
</body>
</html>