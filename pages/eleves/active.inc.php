...
<form method="post" action="?page=eleves&amp;mode=active_do">
	<fieldset>
		<legend>Confirmation</legend>
		<p>Etes-vous s&ucirc;r de vouloir activer l'&eacute;l&egrave;ve "<?php echo($aEleve['ELEVE_NOM']); ?>" ?</p>
	</fieldset>
	<p>
		...
		<input type="submit" name="action" value="Activer" />
