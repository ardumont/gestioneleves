...
CREATE TABLE `PROFESSEURS` (
  ...
  `PROFESSEUR_PROFIL_ID` INT UNSIGNED NOT NULL DEFAULT 1,
...
CREATE TABLE `COMMENTAIRES` (
  ...
  `COMMENTAIRE_VALEUR` varchar(250) NOT NULL,
  `ID_PERIODE` int(11) NOT NULL,
  `ID_ELEVE` int(11) NOT NULL,
  `ID_CLASSE` int(11) NOT NULL,
...
--#STEP()
ALTER TABLE `EVAL_COMPETENCES`
  ADD CONSTRAINT `EVAL_COMPETENCES_ibfk_2` FOREIGN KEY (`ID_EVAL_IND`) REFERENCES `EVALUATIONS_INDIVIDUELLES` (`EVAL_IND_ID`) ON DELETE CASCADE;
